        ...
        <section>
          <div class="filters">
            <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
              ...
              <fieldset>
                <h3>
                  <?php _e('Stream', OSCLASSWIZARDS_THEME_FOLDER); ?>
                </h3>
                <div>
				 <?php osclasswizards_countries_select('sCountry', 'sCountry', __('Select a stream', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(Params::getParam('sCountry')));?>
                </div>
              </fieldset>
			  <?php } ?>
			    <fieldset>
                <h3>
                  <?php _e('University', OSCLASSWIZARDS_THEME_FOLDER); ?>
                </h3>
                <div>
					<?php osclasswizards_regions_select('sRegion', 'sRegion', __('Select a university', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(osc_search_region())) ; ?>
                </div>
              </fieldset>
			  <fieldset>
                <h3>
                  <?php _e('College', OSCLASSWIZARDS_THEME_FOLDER); ?>
                </h3>
                <div>
                    <?php osclasswizards_cities_select('sCity', 'sCity', __('Select a college', OSCLASSWIZARDS_THEME_FOLDER), osc_esc_html(osc_search_city())) ; ?>
                </div>
              </fieldset>
