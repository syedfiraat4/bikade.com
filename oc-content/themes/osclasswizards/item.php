    ...
    <div id="item-content">
      ...
      <div class="item-photos">
        ...
        ?>
          ...
          <div class="col-md-2">
            <div class="thumbs"> <a href="<?php echo osc_current_web_theme_url('images/no_photo.gif'); ?>" class="fancybox" data-fancybox-group="group" title="<?php _e('Image', OSCLASSWIZARDS_THEME_FOLDER); ?> 1 / 1"> <img src="<?php echo osc_current_web_theme_url('images/no_photo.gif'); ?>" width="75" alt="<?php echo osc_item_title(); ?>" title="<?php echo osc_item_title(); ?>" class="img-responsive"/> </a> </div>
          </div>
          <?php } ?>
        </div>
      </div>
